<nav class="fixed top-0 z-30 w-full bg-blue-600 border-b border-blue-700 dark:bg-gray-800 dark:border-gray-700">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <button @click="sidebarOpen = !sidebarOpen" class="p-2 mr-2 text-white rounded cursor-pointer lg:hidden hover:bg-blue-700 dark:hover:bg-gray-700">
                ...
                <a href="/" class="flex ml-2 md:mr-24">
                    <span class="self-center text-xl font-bold sm:text-2xl whitespace-nowrap text-white">Network IT Club</span>
                </a>
            </div>
