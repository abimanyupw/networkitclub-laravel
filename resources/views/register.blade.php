            ...
            <div x-data="{ show:false }">
                ...
                <div class="relative mt-2">
                    <input :type="show ? 'text' : 'password'" name="password" required
                        class="w-full px-4 pr-12 py-4 rounded-2xl bg-slate-950/50 border border-slate-800 text-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none"
                        placeholder="••••••••">
