            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                <div class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 text-xs text-gray-400 font-mono bg-gray-50 dark:bg-slate-800 px-3 py-1.5 rounded-lg w-fit">
                            <span>Slug:</span>
                    ...
                    <div class="pt-8 flex justify-start gap-3 border-t border-gray-100 dark:border-gray-800">
                        <a href="{{ route('manageinformation.index') }}" class="px-8 py-3 bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-gray-300 rounded-2xl font-bold hover:bg-gray-200 transition">
                            Kembali ke Daftar
                        </a> 
                    </div>
                </div>
