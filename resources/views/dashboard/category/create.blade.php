...
@section('content')
    <div class="mb-8">
        ...
        <nav class="mt-2 flex items-center gap-2 text-sm text-blue-600 dark:text-blue-400">
            ...
            <a href="/manageuser" class="hover:underline font-medium">Manajemen Kategori</a>
            <span class="text-gray-400">/</span>
            <span class="text-gray-500 dark:text-gray-400 font-medium">Tambah Kategori</span>
        </nav>
    </div>
        <form action="/managecategory" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="p-8 space-y-6">        
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">     
                                <div>
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Cth: Linux Server"
                            ...
                            <div>
                                ...
                                <input type="text" name="slug" placeholder="linux-server" 
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <textarea name="description" placeholder="linux server adalah pengetahuan tentang pembangunan server dengan operating system linux" 
                                       class="w-full h-30 px-4 py-2.5 rounded-xl border @error('description') border-red-500 @else border-gray-200 dark:border-gray-700 @enderror bg-gray-50 dark:bg-slate-800 dark:text-white focus:ring-2 focus:ring-blue-500 transition outline-none"></textarea>
