                ...
                <form action="{{ route('manageassignment.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" 
                                   ...
                                   class="w-full rounded-xl border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-3 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition @error('title') border-rose-500 @enderror" required autofocus>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <input type="datetime-local" name="deadline" id="deadline" value="{{ old('deadline') }}" 
                                   class="w-full rounded-xl border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-3 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="6" 
                                  ...
                                  class="w-full rounded-xl border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-3 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition" required>{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row justify-end gap-3 pt-6 border-t border-slate-100 dark:border-slate-800">
                        ...
                        <button type="submit" 
                                class="px-8 py-3 rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition font-bold shadow-lg shadow-blue-200 dark:shadow-none">
                            Simpan & Publikasikan
                        </button>
                    </div>
                </form>
