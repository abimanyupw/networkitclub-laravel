...
@section('content')
    ...
    <div class="mb-8">
        ...
        <nav class="mt-2 flex items-center gap-2 text-sm text-blue-600 dark:text-blue-400">
            ...
            <a href="{{ route('manageuser.index') }}" class="hover:underline font-medium">Manajemen Anggota</a>
            <span class="text-gray-400">/</span>
            <span class="text-gray-500 dark:text-gray-400 font-medium">Detail Anggota</span>
        </nav>
    </div>
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="bg-blue-50 dark:bg-slate-800 p-3 rounded-xl text-blue-600 dark:text-blue-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.213l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.213-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    </svg>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 uppercase font-bold tracking-wider">Phone</p>
                                    <p class="text-gray-800 dark:text-gray-200 font-medium text-lg">{{ $user->phone ?? 'N/A' }}</p>
                                </div>
                            </div>
