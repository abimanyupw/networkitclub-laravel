...
@section('content')
    <div class="mb-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white italic">Tambah Kelas Baru</h1>
                        ...
                        <div class="p-8 space-y-6">        
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">     
                                <div>
                                    ...
                                    <input type="text" name="title" value="{{ old('title') }}" placeholder="Cth: Cyber Security"
                            ...
                            <div>
                                ...
                                <input type="text" name="slug" placeholder="cyber-security" 
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <textarea name="description" placeholder="Pelajari dasar-dasar keamanan siber, pertahanan jaringan, dan etika hacker untuk melindungi data." 
                                       class="w-full h-30 px-4 py-2.5 text-white rounded-xl border @error('description') border-red-500 @else border-gray-200 dark:border-gray-700 @enderror bg-gray-50 dark:bg-slate-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 transition outline-none"></textarea>
